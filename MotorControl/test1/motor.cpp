...
const double KP_1 = 4.6 , KI_1 = 12  , KD_1 = 0;
const double KP_2 = 4.5 , KI_2 = 12 , KD_2 = 0 ;
...
ISR(TIMER2_COMPA_vect){
    ...
    if(counter >= 100){//頻率50
        speed1 = (counter_diff1 * rad) * 0.0675 / 0.02 / 20;
        PWM1 = pi_control(1,vcmd1,speed1);
        speed2 = (counter_diff2 * rad) * 0.0675 / 0.02 / 20;
...
int pi_control(int num , double vcmd , double sp){
    ...
    static double ERR = 0 , G = 0 , in = 0 , PRE_ERR_1 = 0 , PRE_ERR_2 = 0;
