...
num = 1
x = np.load("npy_0619/x_" + str(num) + ".npy")
y = np.load("npy_0619/y_" + str(num) + ".npy")

for i in range(1,17):
	x_now = np.load("npy_0619/x_" + str(i+1) + ".npy")
	y_now = np.load("npy_0619/y_" + str(i+1) + ".npy")
	x = np.vstack((x,x_now)) 
	y = np.vstack((y,y_now))
...
joblib.dump(svc_fit, 'model/svc_20190619.pkl') 
